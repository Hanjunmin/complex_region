...
win=pd.read_csv("/home/jmhan/project/APG/github_final/01_1p36/index_construction/output/cor_window.bed",sep="\t",header=None)  ##allfeaturen是后来改了vscore的结果
win.columns=['chr','start','end']

/home/jmhan/project/APG/github_final/01_1p36/index_construction/seq_div/simal

###Seq_div
entropy=pd.read_csv("/home/jmhan/project/APG/github_final/01_1p36/index_construction/seq_div/entropy_final.txt",sep="\t",header=None)
entropy.columns=['chr','start','end',"entropy"]
FEATUREIN=entropy
simial=pd.read_csv("/home/jmhan/project/APG/github_final/01_1p36/index_construction/seq_div/simal",sep="\t",header=0)
simial.columns=['chr','start','end',"win_sim"]
FEATUREIN=pd.merge(FEATUREIN, simial, how='left', on=['chr','start','end'])

###TE
TEvar=pd.read_csv("/home/jmhan/project/APG/github_final/01_1p36/index_construction/TE_div/TEEND",sep="\t",header=0)
...
###inter_seg
interseg=pd.read_csv("/home/jmhan/project/APG/github_final/01_1p36/index_construction/inter_seg/reg.simout",sep="\t",header=0)
...
###intra_seg
intraseg= pd.read_csv("/home/jmhan/project/APG/github_final/01_1p36/index_construction/intra_seg/intra_seg.fea",header=0,sep="\t")  ##allfeaturen是后来改了vscore的结果
...
refinebubble = pd.read_csv("/home/jmhan/project/APG/github_final/01_1p36/index_construction/bub/bub.txt",header=None,sep="\t")
...
X = APGin2
import joblib
scaler = joblib.load('/home/jmhan/project/APG/github_final/01_1p36/model/models/standard_scaler.pkl')  # 替换为你的pkl文件路径
...
filename="/home/jmhan/project/APG/github_final/01_1p36/model/models/lianxu"+str(150)+"_"+str(10)+"_dc.end.weights.h5"
...
filename = "/home/jmhan/project/APG/github_final/01_1p36/model/models/lianxu"+str(150)+"_"+str(10)+"_dc.fin.weights.h5"
...
cluster_columns = [f'Cc{i}' for i in range(8)]
df = out[['POS'] + cluster_columns]  # 正确拼接列名列表

colors=["#efefef",'#a02735','#a87fb7','#2876bc','#684f7f','#d52918','#da8e3d','#b96289']
...
plt.title('Genomic Region Feature Visualization', fontsize=16)
...
#plt.savefig(CHR+"_"+str(s)+"_"+str(e)+'_anno.complex.pdf', format='pdf', dpi=300)
plt.show()
