...
##/share/home/zhanglab/user/maoyafei/project/ENDVNTR
...
parser.add_argument('--w', help='W path')
parser.add_argument('--json', help='region json path')
...
# CHRn="chr2"
# samstart=0
# T2Tchmpos="/share/home/zhanglab/user/maoyafei/project/panVNTR/data/chrY.posCHM.txt"
...
for sams in range(len(split_lists)): # for samlis in split_lists:
	...
	Wfile_list=samlis
	alist=[] 
	with concurrent.futures.ProcessPoolExecutor(max_workers=int(args.p)) as executor:
