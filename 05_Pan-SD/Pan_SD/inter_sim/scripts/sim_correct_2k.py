...
parser.add_argument('--p', help='path of inter-seg homo database')
...
def process_line(line):
    ...
    columns_to_keep = [col for col in dfall.columns if col not in columns_to_drop]
    dfall[columns_to_keep] = dfall[columns_to_keep].astype(str)
...
with open(args.p+'/inter_sim/DB/inter_seg_kmer.pkl', 'rb') as f:
